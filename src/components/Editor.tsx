...
import { Heart, Image as ImageIcon, Type, Palette, Calendar, Play, Music, RotateCcw, Upload, Gift, Crop, X, Check } from 'lucide-react';
...
export const Editor: React.FC<EditorProps> = ({ state, onChange, onShare, onReset }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white border-l border-slate-200 shadow-2xl overflow-y-auto">
      <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-rose-50/50 sticky top-0 z-10 backdrop-blur-sm">
